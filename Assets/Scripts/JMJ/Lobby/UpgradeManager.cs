...
public class UpgradeManager : MonoBehaviour
{
    ...
    // =====================================================
    // 스테이지 클리어 골드 보상 강화 설정
    // =====================================================

    [Header("스테이지 클리어 골드 획득량 강화")]
    ...
    public void UpgradeGoldReward()
    {
        ...
        {
            Debug.Log("스테이지 클리어 골드 획득량은 최대 레벨입니다.");
            return;
        }
    ...
    {
        // SaveManager에서 리셋된 데이터를
        // 다시 읽어서 모든 업그레이드 UI 갱신
        RefreshUI();

        Debug.Log(
            "UpgradeManager 실시간 갱신 완료"
        );
    }
